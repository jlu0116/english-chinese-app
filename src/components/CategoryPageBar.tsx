...
export const CategoryPageBar: React.FC<CategoryPageBarProps> = ({
  ...
  return (
    <div className="shrink-0 pl-3.5 pr-4 py-2 bg-[#F2F2F7] border-b border-black/[0.06] flex items-center justify-between gap-1.5 select-none">
      ...
      <div className="flex p-0.5 bg-slate-200/80 rounded-xl text-xs font-semibold shrink-0">
        {CATEGORIES.map((cat) => {
          ...
          const label = cat.id === 'airport' ? '机场' : '超市';
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 px-3 h-8 sm:h-8.5 rounded-lg transition-all duration-150 cursor-pointer ${
                isSelected
